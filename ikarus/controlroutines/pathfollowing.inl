...
namespace Ikarus {
  ...
  template <typename NonLinearSolver, typename PathFollowingType,
            typename AdaptiveStepSizing>requires (Impl::checkPathFollowingTemplates<NonLinearSolver,PathFollowingType,AdaptiveStepSizing>())
