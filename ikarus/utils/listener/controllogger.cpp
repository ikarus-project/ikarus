...
void ControlLogger::controlStarted(const std::string& pathFollowingName) {
...
void ControlLogger::controlEnded(int totalIterations, const std::string& pathFollowingName) {
