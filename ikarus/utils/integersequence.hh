...
constexpr auto set_intersection(std::integer_sequence<T, I...> seq1, std::integer_sequence<T, J...> seq2) {
  constexpr auto pair = Impl::set_intersectionImpl<seq1, seq2>();

  auto iSeq = std::make_index_sequence<pair.second>{};
  return Dune::unpackIntegerSequence([&](auto... i) { return std::integer_sequence<T, pair.first[i]...>{}; }, iSeq);
}
} // namespace Dune
