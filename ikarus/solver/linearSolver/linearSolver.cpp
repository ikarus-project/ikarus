...
namespace Ikarus {
  ...
  ILinearSolverTemplate<ScalarType>::ILinearSolverTemplate(const SolverTypeTag& p_solverTypeTag) : solverTypeTag{p_solverTypeTag} {
  ...
  template class ILinearSolverTemplate<double>;
