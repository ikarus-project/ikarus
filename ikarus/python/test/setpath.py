...
# import setpath
# setpath.set_path()
# Maybe there is a fix coming from clion, see the bugreport https://youtrack.jetbrains.com/issue/CPP-32280

def set_path():
    sys.path.append('/tmp/Ikarus/cmake-build-debug-dockerpython/python')
