...
if (isNotRegistered)
{
  ...
  lv.def(
      ...
      [](FERequirements& self,  SolutionVectorType solVec) {
        self.insertGlobalSolution( solVec);
  ...
  lv.def(
      "insertParameter",
      [](FERequirements& self, ValueWrapper<double>& parVal) {
        self.insertParameter(parVal.val);
      },
