...
//
//    UnitVectorMod() = default;
//
//    /** \brief Copy-Constructor from the values in terms of coordinateType */
//    explicit UnitVectorMod(const CoordinateType &vec) noexcept : var{vec.normalized()} {}
//
//    /** \brief Move-Constructor from the values in terms of coordinateType */
//    explicit UnitVectorMod(CoordinateType &&vec) noexcept : var{vec.normalized()} {}
//
...
//    template<typename Scalar>
//    auto squaredDistance(const UnitVectorMod<Scalar,d> &other) const {
...
//
//    template<typename Scalar>
//    CorrectionType derivativeOfDistanceSquaredWRTSecondArgument( const UnitVectorMod<Scalar,d> & other) const {
//      return other.orthonormalFrame().transpose()*euclideanDerivativeOfDistanceSquaredWRTSecondArgument(other);
//    }
//
//    template<typename Scalar>
//    Eigen::Matrix<Scalar,d-1,d-1> secondDerivativeOfDistanceSquaredWRTSecondArgument( const UnitVectorMod<Scalar,d> & other) const {
//
//      const auto dotprod = var.dot(other.var);
...
//    UnitVectorMod<ctype, d>
//        &operator=(const UnitVectorMod<ctype_, d> &other) {
//      var = other.var;
//      return *this;
//    }
//
...
//    struct rebind {
//      using other = UnitVectorMod<OtherType, valueSize>;
//    };
//
...
//  bool operator==(const UnitVectorMod<ctype2, d2> &v1, const UnitVectorMod<ctype2, d2> &v2) {
//    return v1.getValue() == v2.getValue();
//  }
//
//  template <typename ctype2, int d2>
//  std::ostream &operator<<(std::ostream &s, const UnitVectorMod<ctype2, d2> &var2) {
//    s << var2.getValue();
//    return s;
//  }
//
//  template <typename ctype2, int d2>
//  [[nodiscard]] UnitVectorMod<ctype2, d2> update(const UnitVectorMod<ctype2, d2> &rt,
//                                              const typename UnitVectorMod<ctype2, d2>::CorrectionType &correction) {
//    return UnitVectorMod<ctype2, d2>(rt.getValue() + rt.orthonormalFrame() * correction);
//  }
//
//  template <typename ctype2, int d2>
//  [[nodiscard]] UnitVectorMod<ctype2, d2> operator+(const UnitVectorMod<ctype2, d2> &rt,
//                                                 const typename UnitVectorMod<ctype2, d2>::CorrectionType &correction) {
//    return UnitVectorMod<ctype2, d2>(rt.getValue() + rt.orthonormalFrame() * correction);
//  }
//
...
//  [[nodiscard]] RealTuple<ctype2, d2> operator*(const UnitVectorMod<ctype2, d2> &rt, const Scalar &factor) {
//    return RealTuple<ctype2, d2>(rt.getValue() * factor);
//  }
//
//  template <typename ctype2, int d2, typename Scalar>
//    requires std::is_arithmetic_v<Scalar>
//  [[nodiscard]] RealTuple<ctype2, d2> operator*(const Scalar &factor, const UnitVectorMod<ctype2, d2> &rt) {
//    return rt * factor;
//  }
