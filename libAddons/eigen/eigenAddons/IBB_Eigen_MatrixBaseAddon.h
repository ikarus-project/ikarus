 ...
 * \version 22.01.2020
 */
inline Derived inverse_33 ( )
{
  return this->inverse();
}


/** partially copied from\src\ThirdParty\eigen3\Eigen\src\Geometry\OrthoMethods.h but removed assert (ONLY FOR LEGACY DO NOT USE THIS)
*
* \author Alex Müller
* \version 09.05.2020
*/
...
//    Q.col(colIndex) -= Q.leftCols(colIndex) * (Q.leftCols(colIndex).transpose() * (*this).col(colIndex));
