...
Additionally, we created a workflow which automatically creates a release on [github](https://github.com/ikarus-project/ikarus/releases) 
and to [DARUS](https://darus.uni-stuttgart.de/dataset.xhtml?persistentId=doi%3A10.18419%2Fdarus-3303&version=DRAFT), which 
enables us to assign a doi to the current version.
...
- [ ] Workflows
    ...
    * [x] Create release workflow to add a version to [DARUS](https://darus.uni-stuttgart.de/dataset.xhtml?persistentId=doi%3A10.18419%2Fdarus-3303&version=DRAFT)
