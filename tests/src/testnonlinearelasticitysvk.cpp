...
int main(int argc, char** argv) {
...

  {
    ...
    t.subTest(checkFESByAutoDiff(
        ...
        skills(Ikarus::nonLinearElastic(reducedMat), volumeLoad<2>(vL), neumannBoundaryLoad(&neumannBoundary, nBL)),Ikarus::AffordanceCollections::elastoStatics));
  }

  {
    ...
    t.subTest(checkFESByAutoDiff(
        ...
        skills(Ikarus::nonLinearElastic(matSVK1), volumeLoad<3>(vL), neumannBoundaryLoad(&neumannBoundary, nBL)),Ikarus::AffordanceCollections::elastoStatics));
  }
