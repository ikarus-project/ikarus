 ...
 * the finite element
 */
template <typename PREFunc, typename PreBasis, typename ReferenceElement, typename Skills, typename... AF, typename... F>
auto testFEElement(const PreBasis& preBasis, const std::string& elementName, const CornerDistortionFlag& distortionFlag,
                   const ReferenceElement& refElement, PREFunc&& preFunc, Skills&& additionalSkills,Ikarus::AffordanceCollection<AF...> affos, F&&... f) {
...
inline auto checkGradientFunctor = [](auto& nonLinOp, [[maybe_unused]] auto& fe, [[maybe_unused]] auto& req,[[maybe_unused]] auto& affo) {
  return checkGradientOfElement(nonLinOp);
};
inline auto checkHessianFunctor = [](auto& nonLinOp, [[maybe_unused]] auto& fe, [[maybe_unused]] auto& req,[[maybe_unused]] auto& affo) {
  return checkHessianOfElement(nonLinOp);
};
inline auto checkJacobianFunctor = [](auto& nonLinOp, [[maybe_unused]] auto& fe, [[maybe_unused]] auto& req,[[maybe_unused]] auto& affo) {
