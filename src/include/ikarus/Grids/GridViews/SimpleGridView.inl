...
namespace Ikarus::Grid {
  ...
  template <int dim, int dimworld, Ikarus::Concepts::Grid GridType> requires requires {dim > 1;}
  ...
  template <int dim, int dimworld, Ikarus::Concepts::Grid GridType> requires requires {dim > 2;}
