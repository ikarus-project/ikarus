...
namespace Ikarus {
  ...
  public:
    ...
    FlatAssemblerBase(const std::shared_ptr<Basis> &basis, const FEContainer &fes,
                      const std::shared_ptr<std::vector<bool>> &dirichFlags)
    ...
    /**  Creates a the reduced sized vector of size #Dof-#constrainded doffsd inserts the values of full Vector at the
  ...
  public:
    ScalarAssembler(const std::shared_ptr<Basis> &basis, const FEContainer &fes,
                    const std::shared_ptr<std::vector<bool>> &dirichFlags)
  ...
  public:
    VectorFlatAssembler(const std::shared_ptr<Basis> &basis, const FEContainer &fes,
                        const std::shared_ptr<std::vector<bool>> &dirichFlags)
  ...
  public:
    SparseFlatAssembler(const std::shared_ptr<Basis> &basis, const FEContainer &fes,
                        const std::shared_ptr<std::vector<bool>> &dirichFlags)
  ...
  public:
    using RequirementType = typename FEContainer::value_type::FERequirementType;
    using GlobalIndex     = typename FEContainer::value_type::GlobalIndex;
    explicit DenseFlatAssembler(const std::shared_ptr<Basis> &basis, const FEContainer &fes,
                                const std::shared_ptr<std::vector<bool>> &dirichFlags)
        : VectorFlatAssembler<Basis, FEContainer>(basis, fes, dirichFlags) {}
