...
namespace Ikarus {
  ...
  public:
    LoadControl(FEManager& feManager, const LinearAlgebraFunctions<LinearAlgebraFunctionArgs...>& linearAlgebraFunctions,const int loadSteps) : feManager_{&feManager},linearAlgebraFunctions_{linearAlgebraFunctions} ,loadSteps_{loadSteps}{}
