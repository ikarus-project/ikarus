...
namespace Ikarus::FiniteElements {
  ...
  public:
    ...
    template <typename SpaceFunction, typename TimeFunctionReturnType = double,
              typename TimeFunctionParameterType = double>
    ForceLoad(
        GridElementEntityType &gE, const IndexSetType &indexSet, SpaceFunction &&spaceFunction,
