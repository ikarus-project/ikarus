...
//
//  template <typename LocalView, typename IndexSetType>
//  class ElasticityFEBasis : public FEVertexDisplacementBasis<GridElementEntityType, IndexSetType> {
//  public:
//    using Base = FEVertexDisplacementBasis<GridElementEntityType, IndexSetType>;
//    ElasticityFEBasis(LocalView& p_localView , const IndexSetType &indexSet, double emod, double nu)
//        : Base(gE, indexSet), localView{p_localView}, emod_{emod}, nu_{nu} {}
//
