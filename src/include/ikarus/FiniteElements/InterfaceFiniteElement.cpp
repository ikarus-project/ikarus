...
namespace Ikarus::FiniteElements {
  ...
  std::pair<Eigen::MatrixXd, Eigen::VectorXd> calculateLocalSystem(const IFiniteElement& fe,IFiniteElement::VariableVectorType& vars,
                                                                   const MatrixAffordances& matA,
                                                                   const VectorAffordances& vecA) {
    return fe.feimpl->do_calculateLocalSystem(vars,matA, vecA);
  }
  Eigen::MatrixXd calculateMatrix(const IFiniteElement& fe,IFiniteElement::VariableVectorType& vars, const MatrixAffordances& matA) {
  ...
  Eigen::VectorXd calculateVector(const IFiniteElement& fe,IFiniteElement::VariableVectorType& vars, const VectorAffordances& vecA) {
  ...
  double calculateScalar(const IFiniteElement& fe,IFiniteElement::VariableVectorType& vars, const ScalarAffordances& scalA) {
