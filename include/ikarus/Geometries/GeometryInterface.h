...
namespace Ikarus::Concepts {
    ...
    concept GeometryEntity = requires (GeometryEntityType&& geoEntity,
        ...
        {geoEntity.jacobianInverseTransposed(dN,x)} -> std::same_as<typename GeometryEntityType::JacobianInverseTransposed>;
    };
}
