...
#ifndef FE_DESIGNPATTERN_INTERFACEGEOMETRY_H
#define FE_DESIGNPATTERN_INTERFACEGEOMETRY_H

#include <Eigen/Core>
namespace Ikarus::Concepts {
  template <class GeometryEntityType>
  concept GeometryEntity
      = requires(GeometryEntityType&& geoEntity,
                 Eigen::Matrix<typename GeometryEntityType::ctype, Eigen::Dynamic,
                               GeometryEntityType::mydimension>
                     dN,
                 Eigen::Matrix<typename GeometryEntityType::ctype,
                               GeometryEntityType::coorddimension, Eigen::Dynamic>
                     x) {
    ...
    {
      geoEntity.jacobianTransposed(dN, x)
      } -> std::same_as<typename GeometryEntityType::JacobianTransposed>;
    {
...
#endif  // FE_DESIGNPATTERN_INTERFACEGEOMETRY_H
