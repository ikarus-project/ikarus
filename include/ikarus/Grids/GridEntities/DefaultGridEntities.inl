...
namespace Ikarus::Grid {
    ...
    {
        return std::span(gridEntity->getChildVertices().begin(),
                         gridEntity->getChildVertices().end());
    }
...
Dune::GeometryType DefaultGridEntity<griddim, 0, wdim>::type() const
{
  switch (mydimension)
  {
    case 0 : DUNE_THROW(Dune::InvalidStateException, "The type of this element should not be only a vertex");;
    case 1 : return Dune::GeometryTypes::line;
    case 2 :
      switch(subEntities(dimension)){
        ...
        case 3: return Dune::GeometryTypes::triangle;
        case 4: return Dune::GeometryTypes::quadrilateral;
        default:
          DUNE_THROW(Dune::NotImplemented, "There is no fundamental geometry type for more than 4 vertices.");
      }
    case 3:
      switch(subEntities(dimension)){
        case 4: return Dune::GeometryTypes::tetrahedron;
        case 5: return Dune::GeometryTypes::pyramid;
        case 6: return Dune::GeometryTypes::prism;
        case 8: return Dune::GeometryTypes::hexahedron;
        default:
...
Dune::GeometryType DefaultGridEntity<griddim, cogriddim, wdim>::type() const
{
  switch (mydimension)
  {
    case 0 : DUNE_THROW(Dune::InvalidStateException, "The type of this subEntity should not be only a vertex");;
    case 1 : return Dune::GeometryTypes::line;
    case 2 :
      switch(subEntities(dimension)){
        case 0:
