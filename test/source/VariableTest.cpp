...
TEST(DefaultVariableTest, UnitVectorDirector) {
    ...
    EXPECT_THAT(d.getValue(),EigenApproxEqual(Eigen::Vector<double,3>(0.18688672392660707344,0.97140452079103167815,-0.14644660940672621363),tol));
...
TEST(VariableTest, GenericVariableVectorTest) {
    ...
    EXPECT_THAT(getValue(varVec[3]), EigenApproxEqual(Eigen::Vector3d(0.41279806929140905325,0.50645665044957854928,-0.75703329861022516933),tol));
}
