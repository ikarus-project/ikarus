...
if(Eigen3_FOUND)
    dune_register_package_flags(LIBRARIES Eigen3::Eigen
            COMPILE_DEFINITIONS "ENABLE_EIGEN=1;EIGEN_INITIALIZE_MATRICES_BY_NAN=1")
endif()
...
function(add_dune_Eigen3_flags _targets)
    if(Eigen3_FOUND)
        foreach(_target ${_targets})
            ...
            target_compile_definitions(${_target} PUBLIC ENABLE_EIGEN=1 EIGEN_INITIALIZE_MATRICES_BY_NAN=1)
        endforeach(_target)
    endif()
