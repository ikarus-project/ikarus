...
# https://github.com/dune-project/dune-istl/blob/master/cmake/modules/FindSuperLU.cmake
...
#
# :code:`SuperLU_FOUND` True if SuperLU available and usable.
#
# :code:`SUPERLU_INCLUDE_DIRS` Path to the SuperLU include dirs. .. deprecated:: 2.8 Use target
# SuperLU::SuperLU instead.
#
# :code:`SUPERLU_LIBRARIES` Name to the SuperLU library. .. deprecated:: 2.8 Use target
# SuperLU::SuperLU instead.
#
# This module provides the following imported targets, if found:
#
# :code:`SuperLU:SuperLU` Library and include directories for the found SuperLU.
#
# This module provides the following imported targets, if found:
#
# :code:`SuperLU:SuperLU` Library and include directories for the found SuperLU.
...
set(SUPERLU_INT_TYPE
    "int"
    CACHE STRING "The integer version that SuperLU was compiled for (Default is int.
  Should be the same as int_t define in e.g. slu_sdefs.h"
)

find_package(BLAS QUIET)

find_path(SUPERLU_INCLUDE_DIR supermatrix.h PATH_SUFFIXES "superlu" "SuperLU" "SRC")

find_library(
  SUPERLU_LIBRARY NAMES "superlu" "superlu_5.2.1" "superlu_5.2" "superlu_5.1.1" "superlu_5.1"
                        "superlu_5.0"
)

# check version of SuperLU
find_file(
  SLU_UTIL_HEADER slu_util.h
...
find_package_handle_standard_args(
  "SuperLU"
  REQUIRED_VARS SUPERLU_LIBRARY SUPERLU_INCLUDE_DIR SLU_UTIL_HEADER BLAS_FOUND
...
if(SuperLU_FOUND)
  if(NOT TARGET SuperLU::SuperLU)
    ...
    set_target_properties(
      SuperLU::SuperLU PROPERTIES IMPORTED_LOCATION ${SUPERLU_LIBRARY} INTERFACE_INCLUDE_DIRECTORIES
                                                                       "${SUPERLU_INCLUDE_DIR}"
    )
    # Link BLAS library
    if(TARGET BLAS::BLAS)
      ...
      target_link_libraries(SuperLU::SuperLU INTERFACE ${BLAS_LINKER_FLAGS} ${BLAS_LIBRARIES})
    endif()
  endif()
  # log result
